...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CLOCK_XMC4" URI="http://resources/4.0.22/app/CLOCK_XMC4/0" description="CLOCK_XMC4 APP configures system and peripheral clocks." version="4.0.22" minDaveVersion="4.0.0" instanceLabel="CLOCK_XMC4_0" appLabel="">
  ...
  <upwardMapList xsi:type="ResourceModel:RequiredApp" href="../../ECAT_SSC/v4_0_26/ECAT_SSC_0.app#//@requiredApps.3"/>
  ...
  <virtualSignals name="clk_external_output" URI="http://resources/4.0.22/app/CLOCK_XMC4/0/vs_extclk" hwSignal="extclk" hwResource="//@hwResources.8" required="false"/>
  <virtualSignals name="external_clock_pin" URI="http://resources/4.0.22/app/CLOCK_XMC4/0/vs_extclkpin" hwSignal="pad" hwResource="//@hwResources.11" required="false"/>
  <virtualSignals name="osc_hp_watchdog_trap" URI="http://resources/4.0.22/app/CLOCK_XMC4/0/vs_sysoscwd_trap" hwSignal="trap" hwResource="//@hwResources.12" required="false"/>
  <virtualSignals name="system_vco_lock_trap" URI="http://resources/4.0.22/app/CLOCK_XMC4/0/vs_sysvcolock_trap" hwSignal="trap" hwResource="//@hwResources.13" required="false"/>
  <virtualSignals name="usb_vco_lock_trap" URI="http://resources/4.0.22/app/CLOCK_XMC4/0/vs_usbvcolock_trap" hwSignal="trap" hwResource="//@hwResources.14" required="false"/>
  <virtualSignals name="osc_ulp_watchdog_trap" URI="http://resources/4.0.22/app/CLOCK_XMC4/0/vs_ulpwdg_trap" hwSignal="trap" hwResource="//@hwResources.15" required="false"/>
  <virtualSignals name="external_clock_pin_signal" URI="http://resources/4.0.22/app/CLOCK_XMC4/0/__pin_vs_extclkpin" hwSignal="pin" hwResource="//@hwResources.16"/>
